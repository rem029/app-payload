...
DROP TABLE "news_letters_reviews_comments" CASCADE;
DROP TABLE "news_letters_reviews" CASCADE;
DROP TABLE "news_letters_reviews_rels" CASCADE;
DROP TABLE "_news_letters_reviews_v_version_comments" CASCADE;
DROP TABLE "_news_letters_reviews_v" CASCADE;
DROP TABLE "_news_letters_reviews_v_rels" CASCADE;
DROP TABLE "news_letter" CASCADE;
DROP TABLE "news_letter_rels" CASCADE;
